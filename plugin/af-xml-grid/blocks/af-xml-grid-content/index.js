...
/***/ "./src/blocks/af-xml-grid-content/index.js":
/*!*************************************************!*\
  !*** ./src/blocks/af-xml-grid-content/index.js ***!
  \*************************************************/
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/af-xml-grid-content/style.scss");
...
const blockClassNames = (attributes, editor = true) => {
  ...
  return ['af-xml-grid-content', settings?.type ? '--type-' + settings?.type : null, settings?.fullWidth ? '--full-width' : null, settings?.lineClamp ? '--line-clamp' : null].filter(Boolean).join(' ');
};
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('af/xml-grid-content', {
  edit: ({
    attributes,
    setAttributes
  }) => {
    ...
    const blockStyles = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useMemo)(() => getBlockStyles(settings), [settings]);
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    ...
    }), type === 'link' ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextControl, {
      key: "label",
      label: "Label",
      value: label,
      onChange: newValue => updateSettings({
      ...
      __next40pxDefaultSize: true,
      __nextHasNoMarginBottom: true
    }) : null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.__experimentalGrid, {
      columns: 2,
      columnGap: 10,
      rowGap: 10
      ...
      ...blockProps
    }, label || TYPE_OPTIONS.find(item => item?.value === type)?.label || 'Card Content'));
  },
  save: ({
    attributes
  }) => {
...
/***/ "./src/blocks/af-xml-grid-content/style.scss":
/*!***************************************************!*\
  !*** ./src/blocks/af-xml-grid-content/style.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"af-xml-grid-content/index": 0,
/******/ 			"af-xml-grid-content/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["af-xml-grid-content/style-index"], () => (__webpack_require__("./src/blocks/af-xml-grid-content/index.js")))
